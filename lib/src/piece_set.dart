...
enum PieceSet {
	...
	/// 3D piece sets
	basic('Basic', PieceSet.basicAssets),
	experimental('Experimental', PieceSet.experimentalAssets),
	redvblue('RedVBlue', PieceSet.redvblueAssets),
	trimmed('Trimmed', PieceSet.trimmedAssets),
	modernwood('ModernWood', PieceSet.modernwoodAssets),
	...
	static const PieceAssets modernwoodAssets = {
       ...
       /// Set containing 2d PieceSets
	static const Set<PieceSet> _pieceSets2d = {
		PieceSet.cburnett,
		PieceSet.merida,
		PieceSet.pirouetti,
		PieceSet.chessnut,
	...
	/// Set containing 3d PieceSets
	static const Set<PieceSet> _pieceSets3d = {
		PieceSet.basic,
	...
	static List<PieceSet> get pieceSets2d => _pieceSets2d.toList();
	static List<PieceSet> get pieceSets3d => _pieceSets3d.toList();
